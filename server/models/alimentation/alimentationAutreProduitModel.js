...
arraySchema.pre("save", function (next) {
  ...
  this.business_projection.stock_cave = this.business_projection.stock_gen - this.business_projection.sortie_dego;
  ...
  this.vente_journaliere.qt_vendue = this.business_projection.stock_cave - this.stock_apres_vente.reste_stock;
  this.vente_journaliere.valeur = this.vente_journaliere.ref_prix_det * this.vente_journaliere.qt_vendue;
  this.benefice_sur_vente = ( (this.vente_journaliere.qt_vendue * this.business_projection.marge_beneficiaire) / this.business_projection.stock_gen).toFixed(2);
...
const AlimentationAutreProduit = mongoose.model("AlimentationAutreProduit", AutreProduitSchema);

module.exports = AlimentationAutreProduit;
