...
const BrasimbaSubSchema = new mongoose.Schema ({
    achat_journalier:
    {
        qt_caisse: { 
            type: Number,
...
const BrasimbaSchema = new mongoose.Schema({
   ...
   data:[ BrasimbaSubSchema ],
   stats: [statsArray]
});

BrasimbaSubSchema.pre ( 'save', function (next)
{
...
const Brasimba = mongoose.model ( 'Brasimba', BrasimbaSchema);
