  ...
  stock_apres_vente: {
    reste_stock_comptoir: {
      qt_btll: {
        ...
        require: [
          true,
          "vous devez taper le nombre des bouteilles par caisses ",
        ],
        // validate: [validator.isNumeric, "dois contenir que des chiffres"]
      },
      valeur: {
...
arraySchema.pre("save", function (next) {
  ...
  this.business_projection.stock_gen =
    ...
    this.achat_journalier.qt_btll;
  this.business_projection.stock_dego =
    this.business_projection.stock_gen - this.business_projection.sortie_cave;
  ...
  this.business_projection.marge_beneficiaire =
    this.business_projection.val_stock_det -
    this.business_projection.val_stock_gros;
  this.vente_journaliere.qt_vendue_comptoir =
    this.business_projection.stock_gen -
    (this.stock_apres_vente.reste_stock_comptoir.qt_btll +
      this.stock_apres_vente.reste_stock_depot.qt_btll);
  this.vente_journaliere.valeur =
    this.vente_journaliere.ref_prix_det *
    this.vente_journaliere.qt_vendue_comptoir;
  this.benefice_sur_vente = (
    (this.vente_journaliere.qt_vendue_comptoir *
      this.business_projection.marge_beneficiaire) /
    this.business_projection.stock_gen
  ).toFixed(2);
  this.stock_consignaions.valeur =
    this.stock_consignaions.qt * this.vente_journaliere.ref_prix_det;
  this.stock_apres_vente.reste_stock_comptoir.valeur =
    this.stock_apres_vente.reste_stock_comptoir.qt_btll *
    this.vente_journaliere.ref_prix_det;
  this.stock_apres_vente.reste_stock_depot.valeur =
    this.stock_apres_vente.reste_stock_depot.qt_btll *
    this.vente_journaliere.ref_prix_det;
  this.stock_apres_vente.valeur_stock =
    this.stock_apres_vente.reste_stock_depot.valeur +
    this.stock_apres_vente.reste_stock_comptoir.valeur;
  this.suivi1.valeur =
    this.suivi1.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi2.valeur =
    this.suivi2.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi3.valeur =
    this.suivi3.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi4.valeur =
    this.suivi4.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi5.valeur =
    this.suivi5.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi6.valeur =
    this.suivi6.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi7.valeur =
    this.suivi7.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi8.valeur =
    this.suivi8.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi9.valeur =
    this.suivi9.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi10.valeur =
    this.suivi10.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi11.valeur =
    this.suivi11.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi12.valeur =
    this.suivi12.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi13.valeur =
    this.suivi13.qt_caisse * this.achat_journalier.prix_achat_gros;
  this.suivi14.valeur =
    this.suivi14.qt_caisse * this.achat_journalier.prix_achat_gros;
...
const Liqueurs = mongoose.model("Liqueurs", AutreProduitSchema);

module.exports = Liqueurs;
