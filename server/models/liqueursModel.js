...
const LiqueursSubSchema = new mongoose.Schema ({
    achat_journalier:
    {
        qt_caisse: { 
            type: Number,
...
const LiqueursSchema = new mongoose.Schema({
   ...
   data:[ LiqueursSubSchema ],
   stats: [statsArray]
});

LiqueursSubSchema.pre ( 'save', function (next)
{
...
const Liqueurs = mongoose.model ( 'Liqueurs', LiqueursSchema);
