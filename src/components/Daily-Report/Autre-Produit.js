...
export function AutreProduit ()
{
    const [autreProduitData, setAutreProduitdata] = useState (data);
    ...
    let displayDataMainExcel = autreProduitData.map (
        prev => {
            return (
                <ExcelMain 
                    prev = { prev }
    ...
    return (
        <div>
            <ExcelSecLayout name = {displayDataMainExcel}/>
        </div>
    )
}
