    ...
    if (data.bralima && data.brasimba && data.liqueurs && data.autreProduit) {
        ...
        if (data.bralima.length > 0 && data.brasimba.length > 0 && data.liqueurs.length > 0 && data.autreProduit.length > 0) {
            ...
            return (<div  className=" justify-center flex"> 
                ...
                <h3 className="text-2xl font-semibold text-gray-700 absolute"> APPROVISIONNEMENT</h3>
          ...
          return (<div className="m-4">
                <h3 className="text-2xl font-semibold text-gray-700"> APPROVISIONNEMENT</h3>
        ...
        return (<div className=" justify-center flex">
            <h3 className="text-2xl font-semibold text-gray-700 block absolute"> APPROVISIONNEMENT</h3>
