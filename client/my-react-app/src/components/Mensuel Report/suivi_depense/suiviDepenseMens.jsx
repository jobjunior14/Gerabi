       ...
       if (data) {
        ...
        if (data.entreeCaisse.length > 0 && data.sortieCaisse.length > 0 ) {
            ...
            return (<div className=" justify-center flex">
                <h2 className="text-3xl font-bold text-gray-800 mb-5 absolute"> Suivi Depense</h2>
            ...
            return (<div className="m-4">
                <h3 className="text-2xl font-semibold text-gray-700"> VENTE BAR</h3>
            ...
            return (<div className=" justify-center flex">
                    <h3 className="text-2xl font-semibold text-gray-700 block absolute"> VENTE BAR</h3>
