...
export default function Clients ({loading}){
   ...
   if (!loading && clientsData) {
        if (clientsData.length > 0) {
            ...
            <div className=" text-center justify-center items-center block mt-5">
                <div className=" flex justify-center mt-10">
                    <h3 className="lg:text-2xl text-xl font-semibold text-gray-700 block -mt-5 absolute"> Dette Clients </h3>
                    <div className=" border-2 border-slate-600 max-w-fit overflow-x-auto px-4 mt-4 rounded-lg ">
           ...
           return (
                <div className="m-4">
                    <h3 className="lg:text-2xl text-xl font-semibold text-gray-700"> Dette Clients </h3>
        ...
        return (<div className=" justify-center flex">
                <h3 className="lg:text-2xl text-xl font-semibold text-gray-700 block absolute"> Dette Clients</h3>
